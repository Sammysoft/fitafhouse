        ...
        <section id="download">
            <div className="row" style={{padding: "10%", fontSize: "13px"}}>
                <div className="col-md-3 mb-5">
                    <div data-aos="fade-up" data-aos-duration="500" data-aos-anchor-placement="top-bottom" className="text-center" style={{borderTop: '5px solid #6bbe43',borderBottom: '5px solid #6bbe43', height: "auto", width:"auto",padding: "20px", boxShadow: "0px 5px 5px 0px #888888" }}>
                ...
                <div className="col-md-3 mb-5">
                    ...
                    <div  data-aos="fade-up" data-aos-duration="1000" data-aos-anchor-placement="top-bottom" className="text-center" style={{borderTop: '5px solid #6bbe43',borderBottom: '5px solid #6bbe43', height: "auto", padding: "20px", boxShadow: "0px 5px 5px 0px #888888"}}>
                ...
                <div className="col-md-3">
                    <div data-aos="fade-up" data-aos-duration="2000" data-aos-anchor-placement="top-bottom" className="text-center" style={{borderTop: '5px solid #6bbe43',borderBottom: '5px solid #6bbe43', height: "auto", padding: "20px", boxShadow: "0px 5px 5px 0px #888888"}}>
                        <i className="bi bi-bag-fill icon-feature text-gradient d-block mb-3"></i>
                ...
                <div className="col-md-3">
                    <div data-aos="fade-up" data-aos-duration="3000" data-aos-anchor-placement="top-bottom" className="text-center" style={{borderTop: '5px solid #6bbe43', borderBottom: '5px solid #6bbe43', height: "auto", padding: "20px", boxShadow: "0px 5px 5px 0px #888888"}}>
