            ...
            <div className="section1-item">
              ...
              >
                ...
                <p className="text-muted mb-0">
                  ...
                  investment. Our credible team of experts perform all
                  appraisals for the viable project
                </p>
              </div>
            </div>
            <div className="section1-item">
              ...
              >
                ...
                <p className="text-muted mb-0">
                  This section performs all sourcing of funds for viable
                  projects, mainly through the instrumentality of equity
                  financing, debt financing and grant processing
                </p>
              </div>
            </div>
            <div className="section1-item">
