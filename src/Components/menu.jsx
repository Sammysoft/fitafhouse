        ...
        <section id="download">
            <div className="row" style={{padding: "10%", fontSize: "13px"}}>
                <div className="col-md-3 mb-5">
                    <div className="text-center" style={{borderTop: '5px solid #6bbe43',borderBottom: '5px solid #6bbe43', height: "auto", width:"auto",padding: "20px", boxShadow: "0px 5px 5px 0px #888888" }}>
                ...
                <div className="col-md-3 mb-5">
                    ...
                    <div className="text-center" style={{borderTop: '5px solid #6bbe43',borderBottom: '5px solid #6bbe43', height: "auto", padding: "20px", boxShadow: "0px 5px 5px 0px #888888"}}>
