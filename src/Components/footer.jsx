...
const Footer = () =>{
    return(
        <>
            ...
            <div className="container" style={{display: "flex", flexDirection: "column", color: 'white'}}>
                <div className="row align-items-center">
                    <div className="col-lg-4 my-3 my-lg-0" style={{flex: "1", padding:"20px", textAlign: "center"}}>
                        <a className="btn btn-dark btn-social mx-2" href="#!"><i class="bi bi-twitter"></i></a>
                        <a className="btn btn-dark btn-social mx-2" href="#!"><i class="bi bi-instagram"></i></a>
                ...
                <div className="nav-menu" style={{ display: 'inline-block', flex: '1', textAlign: "center"}}>
                <ul style={{listStyle: "none", display: 'inline-block', cursor: "pointer"}}>
                    <li style={{display: "inline-block", padding: "20px", fontFamily: "ubuntu"}}>About</li>
                    <li style={{display: "inline-block", padding: "20px", fontFamily: "ubuntu"}}>Contact Us</li>
