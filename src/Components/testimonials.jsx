        ...
        <section className="bg-light">
            <div className="container px-5" id="features">
                <div className="row gx-5 align-items-center justify-content-center justify-content-lg-between">
                    ...
                    <div data-aos="fade-in" data-aos-druration="3000" className="col-12 col-lg-5" style={{fontSize: "10px", fontFamily:"ubuntu"}}>
                    ...
                    <div className="col-sm-8 col-md-6">
                        <div data-aos="flip-down" data-aos-duration="3000" className=""><img  src="/images/info3.jpg" width="100%" height="100%" alt="..." /></div>
                    </div>
                </div>
            </div>
        </section>
